...
###### На данный момент работаю над переверсткой визуальной части отчёта. Так как данный дашборд собирала с нуля ,я максимально была сосредоточена на сборе необходимых данных и составлении Базы Данных.

##### Ниже представлено несколько листов из дашборда.

### Оглавление 
Нажав на кнопку переходим в нужный блок.
...
![img](https://github.com/OlgaTyulkevich/Project_BI_2023/blob/files/%D0%9F%D0%B5%D1%80%D1%81%D0%BE%D0%BD%D0%B0%D0%BB_!!.png)
